...
// ================================== LAM - Daniel Valmassei ===================
 ...
 // QUARTZ DIMENSIONS ======================================================================================================================================================
    ...
    G4Trap* quartz_box = new G4Trap("Quartz", 2*quartz_x, 2*quartz_z, 2*quartz_y, 0);//2*q_yLB);
    ...
    G4Trap* quartz_box2 = new G4Trap("Quartz2", 2*quartz2_x, 2*quartz2_z, 2*quartz2_y, 0);//2*q_yLB2);
